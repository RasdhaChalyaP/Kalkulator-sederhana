...
koma = Button(root, text=",", padx=30, bg="#3d3d3d", fg="white", pady=20, command=lambda: angka("."))

tambah = Button(root, text="+", padx=30, bg="#DAA520", pady=20, command=tambah)
kurang = Button(root, text="-", padx=30, bg="#DAA520", pady=20, command=kurang)
kali = Button(root, text="x", padx=30, bg="#DAA520", pady=20, command=kali)
bagi = Button(root, text="/", padx=30, bg="#DAA520", pady=20, command=bagi)
hapus = Button(root, text="C", padx=30, bg="#3d3d3d", fg="white", pady=20, command=hapus)
sama = Button(root, text="=", padx=150, bg="#DAA520", pady=20, command=sama)
